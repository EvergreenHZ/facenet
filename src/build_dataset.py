...
def main(args):
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            with open('valid_vector_embs.dat', 'wb') as h:  # dump vectors
                pickle.dump(emb, h)
...
def load_and_align_data(image_paths, image_size, margin, gpu_memory_fraction):
    ...
    with open('valid_name_list', 'wb') as f:  # dump data
...
def parse_arguments(argv):
    ...
    parser.add_argument('--image_files', type=str, help='Images to compare', default='./pos_test.txt')
